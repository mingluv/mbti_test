...
var testNum = {
  ...
  "10": {
    "title": "문제 10번",
    "description": "매일 접속할 때마다  치킨메달 10개씩 준다고 한다면??",
    "type": "JP",
    "A": "차곡차곡 다 모아서 한번에 까야지! ",
    "B": "받자마자 치킨메달 사용해 버리기! 상자깡 가즈아~"
  },
  "11": {
    "title": "문제 11번",
...
var result = {
  "INTJ": {
    "mbti": "INTJ<br>메딕",
    "explain": "어떤 상황에서든 침착한 메딕으로서 항상 팀원 주위에서 도움의 손길을 내밀어 줍니다. 신중히 생각하고 다음 상황에 대한 혁신적인 통찰을 보여줍니다. 상상력이 풍부하면서도 결단력이 있고 책임감이 강하여 팀원들에게 긍정적인 에너지를 줍니다. 자신의 능력을 발휘하거나 일하는 모습을 보여주는 것을 좋아합니다. ",
    "explain2": "에너지가 넘치고 비타민 같은 '수다쟁이'는 침착한 메딕에게 활력을 넣어주고, 서로 의지하며 힘이 되어주는 사이입니다.<br><br>반대로 단호하고 엄격한 '메인오더형'와 플레이를 한다면, 서로 생각하는 우선순위가 달라 서로 오해가 생길수도 있습니다.",
    "img": "INTJ.jpg",
    "sub_img" : "INTJ1.png"
  },
  "INTP": {
    ...
    "explain2": "혼자만의 시간을 중요시 하는 당신 옆에서 같이 싸워줄 '여포형'는 의외로 함께있으면 시너지가 날 수 있습니다.<br><br>다만, 정이많고 말거는 것을 좋아하는 '즐겜러'가 주는 호의적인 관심이 당신은 반갑지 않을 수 있습니다.",
    "img": "INTP.jpg",
    "sub_img" : "INTP1.png"
  ...
  "ENTJ": {
    ...
    "explain2": "침착한 '솔플메니아'는 행동대장 당신을 존중하며 여포성을 이해해주는 편안한 짝꿍 입니다.<br><br>하지만 신중하면서 체계적인 '존버형'를 만나면 최악의 파트너..서로간의 의견이 안맞아 답답할 수 있으니 거리를 두는 것이 좋을 것 같아요.",
    "img": "ENTJ.jpg",
    "sub_img" : "ENTJ1.png"
  ...
  "ENTP": {
    ...
    "explain2": "생각하는 것이 비슷하고, 즉흥적이며 창의적인 활동을 좋아하는 '수류탄장인'는 환상의 파트너 입니다.<br><br>반면, 과묵하고 사람이 많은곳을 싫어하는 자유로운 영혼 '걸어다니는 3렙 가방'와는 보급을 찾으러 다니기 어려울 것 같네요..!",
    "img": "ENTP.jpg",
    "sub_img" : "ENTP1.png"
  ...
  "ENFP": {
    "mbti": "ENFP<br>수다쟁이형",
    "explain": "스쿼드의 분위기는 내가 책임진다~! 배그의 스폰지밥! 사람을 기쁘게 해주는 타고난 능력이 있고, 깊은 유대 관계를 맺음으로써 행복을 느낍니다. 새로운 시도를 좋아하며, 항상 수다스럽고 밝은 성격으로 여겨지지만 진지해야 할 상황이 온다면 극도로 진지한 모습을 보여줍니다.",
  ...
  "ISTJ": {
    "mbti": "ISTJ<br>미어캣형",
    "explain": "논리적이고 헌신적으로 임무를 수행하고, 자신이 맡은 임무를 충실히 하는 포탑 포지션의 핵심 구성원 입니다. 승리를 위해 긴장을 놓지 않고 신중하게 사격합니다. 실수한 것을 참지 못하고, 원리 원칙적이며 낯가림 심하고 차가워 보이나 따뜻한 모습이 있습니다. ",
    "explain2": "체계적인 당신 옆을 항상 응원해주는 '스쿼드 매니아'는 안성맞춤 성격의 활기찬 비타민 입니다.<br><br>반면, 나쁜 의미의 접근이 아니지만 적극적인 친화력으로 다가가, 의도치않게 당신의 계획에 방해를 할 수 있는 '수다쟁이형'과는 불편한 감정이 생길 수 있으니 적당히 거리를 지켜주세요.",
    "img": "ISTJ.jpg",
    "sub_img" : "ISTJ1.png"
  ...
  "ISTP": {
    ...
    "explain": "팀원들에게 든든한 만능 재주꾼으로, 타인을 잘 도우며 필요한 물건이 있다면 아낌없이 호의를 배풉니다. 호기심도 풍부하고, 메인 총 뿐만 아니라 석궁, DBS  등 다른 총기에도 관심이 많아 새로운 기술을 하나하나 터득해 나갑니다. 틀에 박핸 생활을 싫아허고 모험을 즐겨 새로운 맵도 금방 적응하며 고정관념이 없는 편입니다.",
